...
os.environ["L5KIT_DATA_FOLDER"] = 'data/sample.zarr'
dm = LocalDataManager(None)
cfg = load_config_data('config/agent_motion_config.yaml')
...
for _ in progress_bar:
    ...
    loss, _ = forward(data, model, device, criterion) # Tensor of shape (1,)
